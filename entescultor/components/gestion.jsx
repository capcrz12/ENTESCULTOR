  ...
  return (
    <div>
      <div className={styles.botones}>
        <button className={styles.cerrar} onClick={handleRecargarDatos}>
          Actualizar datos
        </button>
        <button className={styles.cerrar} onClick={handleLogout}>
          Cerrar Sesión
        </button>
      </div>
      <div className={styles.opciones}>
          ...
          <div className={styles.obrasSinSerie}>
            {opcion === 0 ? (
              <h3 className={styles.error}>
                ¡ATENCIÓN! Existen obras que no están asignadas a ninguna serie
                y no podrán ser visualizadas. Pulse en Obras Sin Serie para
                solucionarlo
              </h3>
            ) : (
              ""
            )}
            <button onClick={handleObrasSinSerie} className={styles.error}>
              {opcion === 18
                ? "Cerrar menu Obras Sin Serie"
                : "Obras Sin Serie"}
            </button>
          </div>
        ) : (
        ...
        <div>
          ...
          <button onClick={handleCrearSerie}>
            {opcion === 1 ? "Cerrar menu Crear Serie" : "Crear serie"}
          </button>
          <button onClick={handleCrearObra}>
            {opcion === 2 ? "Cerrar menu Crear Obra" : "Crear obra"}
          </button>
          {/* <button onClick={handleAnadirAutor}>{opcion === 3 ? 'Cerrar menu Añadir Autor' : 'Añadir autor'}</button> */}
          <button onClick={handleAnadirArticulo}>
            {opcion === 4 ? "Cerrar menu Añadir Artículo" : "Añadir artículo"}
          </button>
          <button onClick={handleAnadirEvento}>
            {opcion === 5 ? "Cerrar menu Añadir Evento" : "Añadir evento"}
          </button>
          <button onClick={handleAnadirCritica}>
            {opcion === 6 ? "Cerrar menu Añadir Crítica" : "Añadir crítica"}
          </button>
        </div>
        <div>
          <h2>MODIFICAR ELEMENTOS</h2>
          <button onClick={handleModificarSerie}>
            {opcion === 7 ? "Cerrar menu Modificar Serie" : "Modificar serie"}
          </button>
          <button onClick={handleModificarObra}>
            {opcion === 8 ? "Cerrar menu Modificar Obra" : "Modificar obra"}
          </button>
          <button onClick={handleModificarAutor}>
            {opcion === 9 ? "Cerrar menu Modificar Autor" : "Modificar autor"}
          </button>
          <button onClick={handleModificarArticulo}>
            {opcion === 10
              ? "Cerrar menu Modificar Artículo"
              : "Modificar artículo"}
          </button>
          <button onClick={handleModificarEvento}>
            {opcion === 11
              ? "Cerrar menu Modificar Evento"
              : "Modificar evento"}
          </button>
          <button onClick={handleModificarCritica}>
            {opcion === 12
              ? "Cerrar menu Modificar Crítica"
              : "Modificar crítica"}
          </button>
        </div>
        <div>
          <h2>ELIMINAR ELEMENTOS</h2>
          <button onClick={handleEliminarSerie}>
            {opcion === 13 ? "Cerrar menu Eliminar Serie" : "Eliminar serie"}
          </button>
          <button onClick={handleEliminarObra}>
            {opcion === 14 ? "Cerrar menu Eliminar Obra" : "Eliminar obra"}
          </button>
          <button onClick={handleEliminarArticulo}>
            {opcion === 15
              ? "Cerrar menu Eliminar Artículo"
              : "Eliminar artículo"}
          </button>
          <button onClick={handleEliminarEvento}>
            {opcion === 16 ? "Cerrar menu Eliminar Evento" : "Eliminar evento"}
          </button>
          <button onClick={handleEliminarCritica}>
            {opcion === 17
              ? "Cerrar menu Eliminar Crítica"
              : "Eliminar crítica"}
          </button>
        </div>
      </div>
      ...
      <div>
        {opcion === 1 ? (
          <AnadirSerieForm
            handleCrearSerie={handleCrearSerie}
            setExito={setExito}
          />
        ) : (
          ""
      ...
      <div>
        {opcion === 3 ? (
          <AnadirAutorForm
            handleAnadirAutor={handleAnadirAutor}
            setExito={setExito}
          />
        ) : (
          ""
      ...
      <div>
        {opcion === 4 ? (
          <AnadirArticuloForm
            handleAnadirArticulo={handleAnadirArticulo}
            setExito={setExito}
          />
        ) : (
          ""
      ...
      <div>
        {opcion === 5 ? (
          <AnadirEventoForm
            handleAnadirEvento={handleAnadirEvento}
            setExito={setExito}
          />
        ) : (
          ""
      ...
      <div>
        {opcion === 6 ? (
          <AnadirCriticaForm
            handleAnadirCritica={handleAnadirCritica}
            setExito={setExito}
          />
        ) : (
          ""
      ...
      <div>
        {opcion === 7 ? (
          <ModificarSerieForm
            handleModificarSerie={handleModificarSerie}
            setExito={setExito}
            series={series}
          />
        ) : (
      ...
      <div>
        {opcion === 8 ? (
          <ModificarObraForm
            handleModificarObra={handleModificarObra}
            setExito={setExito}
            obras={obras}
            series={series}
          />
      ...
      <div>
        {opcion === 9 ? (
          <ModificarAutorForm
            handleModificarAutor={handleModificarAutor}
            setExito={setExito}
            autor={autor}
          />
        ) : (
      ...
      <div>
        {opcion === 10 ? (
          <ModificarArticuloForm
            handleModificarArticulo={handleModificarArticulo}
            setExito={setExito}
            articulos={articulos}
          />
        ) : (
      ...
      <div>
        {opcion === 11 ? (
          <ModificarEventoForm
            handleModificarEvento={handleModificarEvento}
            setExito={setExito}
            eventos={eventos}
          />
        ) : (
      ...
      <div>
        {opcion === 12 ? (
          <ModificarCriticaForm
            handleModificarCritica={handleModificarCritica}
            setExito={setExito}
            criticas={criticas}
          />
        ) : (
      ...
      <div>
        {opcion === 14 ? (
          <EliminarObraForm
            handleEliminarObra={handleEliminarObra}
            setExito={setExito}
            obras={obras}
            series={series}
          />
      ...
      <div>
        {opcion === 17 ? (
          <EliminarCriticaForm
            handleEliminarCritica={handleEliminarCritica}
            setExito={setExito}
            criticas={criticas}
          />
        ) : (
      ...
      <div>
        {opcion === 18 ? (
          <ObrasSinSerieForm
            handleObrasSinSerie={handleObrasSinSerie}
            setExito={setExito}
            obrasSinSerie={obrasSinSerie}
            series={series}
          />
        ) : (
          ""
      ...
      <div className={styles.exito}>{exito || ""}</div>
    </div>
  );
}
